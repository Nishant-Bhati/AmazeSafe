...
const HomeSectionCarousel = () => {
  ...
  return (
    <div className="px-4 lg:px-8">
      ...
      {activeIndex !== 0 && <Button variant="contained" onClick={slidePrev} sx={{position: 'absolute', top: '8rem', left: '0rem',transform: 'translateX(-50%) rotate(-90deg)', bgcolor: 'white'}} aria-label="next">
        <KeyboardArrowLeftIcon sx={{rotate: '90deg', color: 'black'}}/>
      </Button>}
      </div>
    </div>
